...
[![Status](https://img.shields.io/badge/status-published_0.1.3-brightgreen)](PLAN.md)
...
review tour) are all built and shipping in `0.1.3`. `crumb-live.js` drives the lamp + popover
