...
---
🤖 **Built with Claude, and it reads the export, never drives it.** I decided what an outside agent
should be allowed to ask a built page, Claude typed the harvester that answers. **I don't prompt and
pray, I prompt and prove.** [How I actually work with AI, receipts and all →](https://tjakoen.github.io/notes/ten-times-zero)
