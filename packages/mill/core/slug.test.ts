// mill/core/slug.test.ts — the ONE slug algorithm shared by the adapter's heading ids and any
// consumer-side corpus/ToC builder: lock its edge cases so the two can never quietly drift apart.
